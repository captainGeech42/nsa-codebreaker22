...
// https://github.com/golang-jwt/jwt/blob/bfea432b1a9da383509086a2141c06dc103e82f9/http_example_test.go
...
const (
	privKeyPath = "../debug/receipt.key" // openssl genrsa -out app.rsa keysize
	pubKeyPath  = "../debug/receipt.pub" // openssl rsa -in app.rsa -pubout > app.rsa.pub
)
...
type CustomerInfo struct {
	Name string `json:"namepls"`
	Kind string `json:"kindpls"`
}
